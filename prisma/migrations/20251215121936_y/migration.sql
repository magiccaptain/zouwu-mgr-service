/*
  ...
  - The values [O] on the enum `FundAccountType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "FundAccountType_new" AS ENUM ('STOCK', 'FUTURES');
